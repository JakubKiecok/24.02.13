...
<body>
    ...
    <div class="counter">
    <?php
            $counter_records = $conn->query("SELECT COUNT(baza1.ID) as 'ile' FROM baza1 WHERE baza1.Wiek BETWEEN 19 AND 50;");
    ...
    <div class="osoby19-50">
    <ul>
            <?php
                $all_records = $conn->query("SELECT baza1.ID, baza1.Imie, baza1.Nazwisko, baza1.Wiek FROM baza1 WHERE baza1.Wiek BETWEEN 19 AND 50;");
