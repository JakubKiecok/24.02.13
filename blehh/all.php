...
<body>
    ...
    <div class="counter">
        <?php
            $counter_records = $conn->query("SELECT COUNT(baza1.ID) as 'ile' FROM baza1;");
    ...
    <div class="all">
        <ul>
            <?php
                $all_records = $conn->query("SELECT baza1.ID, baza1.Imie, baza1.Nazwisko, baza1.Wiek FROM baza1;");
